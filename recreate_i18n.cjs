...
const resources = {
  ...
  ko: { translation: enTranslation }, // Fallback to English for now
  ja: { translation: enTranslation }, // Fallback to English for now
  zh: { translation: enTranslation }, // Fallback to English for now
  es: { translation: enTranslation }  // Fallback to English for now
};
